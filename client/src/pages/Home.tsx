...
const markImage = "/manus-storage/biblioteca-mark_6078166d.png";
      ...
      <main className="main-content">
        ...
        <div className="content-wrap">
          {view === "overview" && <>
            ...
            <section className="feature-banner" style={{ backgroundImage: `linear-gradient(90deg, rgba(17, 39, 54, 0.97) 0%, rgba(17, 39, 54, 0.84) 42%, rgba(17, 39, 54, 0.18) 100%), url(${heroImage})` }}><div className="feature-copy"><span className="eyebrow eyebrow--light"><Sparkles size={13} /> Caderno do acervo</span><h2>O prazer de encontrar<br /><i>o que já é seu.</i></h2><p>Cadastre, organize e revisite suas leituras com clareza.</p></div><div className="feature-index"><span>01</span><div className="feature-index__line" /><span>04</span></div></section>
